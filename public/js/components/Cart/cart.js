  ...
  const frame = `
    <h1 class="text-left  justify-items-center text-3xl text-sky-600 mt-2 mr-8 ">Mi Carrito</h1>
              <div id="wrapper-content-cart" class="grid grid-cols-3 gap-2 justify-items-center">
                  ...
                  <section id="cart-resume" class="bg-gray-200 rounded-lg ml-4 mr-4 h-fit fixed right-64">
                      ...
                      <div class="gird grid-rows-4 text-center">
                          ...
                          <div class="mt-4 w-full">
                              ...
                              <button id="btn-continue-shopping" class="bg-blue-400 text-white text-sm font-bold rounded-lg px-4 py-2 mt-6 w-2/4 mb-2 shadow-md shadow-slate-500">Continuar comprando</button>
                          </div>
                      </div>
                  </section>
              </div>
